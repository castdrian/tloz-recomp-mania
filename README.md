...
Install the folder as `mods/tloz-recomp-mania`, enable it from the MODS screen, and start an overworld save. The package is API-compatible with the current gen1recomp Red, Blue, and Yellow data sets.
